...
| **11** | `11-CLASSES-AND-OOP-PATTERNS.md` | ES6 `class` desugaring, `constructor`, Instance vs Static methods, Private fields (`#`), Getters/Setters, Inheritance (`extends`, `super()`), Method overriding | `[ ] Up Next` |
