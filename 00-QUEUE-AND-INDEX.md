...
| **12** | `12-REGULAR-EXPRESSIONS-AND-SYMBOLS.md` | RegExp engine, flags (`g`, `i`, `m`, `u`, `s`), Character classes, Quantifiers, Capture groups, Lookaheads/Lookbehinds, `Symbol` primitives | `[ ] Up Next` |
