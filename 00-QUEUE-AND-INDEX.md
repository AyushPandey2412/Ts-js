...
| **19** | `19-BINARY-DATA-AND-BUFFERS.md` | Binary numbers, Hex, Base64, The `Buffer` class, Memory allocation (`alloc` vs `allocUnsafe`), TypedArrays (`Uint8Array`), Buffer manipulation for files | `[ ] Up Next` |
